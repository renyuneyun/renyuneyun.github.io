...
1. Usage Control / Data Terms of Use (DToU): How do we make data usage more accountable and controllable (and easy), for all stakeholders, especially regular people? [[ref]](https://arxiv.org/abs/2403.07587)
      - Regulatory / Compliance: what is the *status quo*, and (how) can we improve that?
2. Data privacy: How to securely and efficiently use multiple users' data (collaboratively) in a decentralised data architecture, **without** losing autonomy? [[ref]](https://arxiv.org/abs/2309.16365)
3. GenAI: What challenges and opportunities do Large-Language Models (LLMs) or personal agents bring (to facilitate people)? [[ref]](https://arxiv.org/abs/2403.10408)
      - See also [Sir Tim Berners-Lee's design notes](https://www.w3.org/DesignIssues/PrivateData.html) on this topic
4. User perception: how do users perceive (the issues of) data and how can we facilitate them?

Feel interested? Find out more [from my papers](./publications.md).
